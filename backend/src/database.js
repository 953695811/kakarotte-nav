...
const defaultNavigation = [
  ...
  // 热门（国内）—— 前 17 项按用户指定顺序，后面补充热门导航
  { name: '抖音', url: 'https://www.douyin.com', description: '短视频平台', category: 'hot', icon: 'https://www.douyin.com/favicon.ico', sort_order: 0, is_default: 1 },
  { name: '哔哩哔哩', url: 'https://www.bilibili.com', description: '弹幕视频网站', category: 'hot', icon: 'https://www.bilibili.com/favicon.ico', sort_order: 1, is_default: 1 },
  { name: '小红书', url: 'https://www.xiaohongshu.com', description: '生活方式社区', category: 'hot', icon: 'https://www.xiaohongshu.com/favicon.ico', sort_order: 2, is_default: 1 },
  { name: 'QQ邮箱', url: 'https://mail.qq.com', description: 'QQ 邮箱服务', category: 'hot', icon: 'https://mail.qq.com/favicon.ico', sort_order: 3, is_default: 1 },
  { name: '网易邮箱', url: 'https://mail.163.com', description: '网易邮箱服务', category: 'hot', icon: 'https://mail.163.com/favicon.ico', sort_order: 4, is_default: 1 },
  { name: '网易云音乐', url: 'https://music.163.com', description: '音乐平台', category: 'hot', icon: 'https://music.163.com/favicon.ico', sort_order: 5, is_default: 1 },
  { name: '酷狗音乐', url: 'https://www.kugou.com', description: '音乐播放与下载', category: 'hot', icon: 'https://www.kugou.com/favicon.ico', sort_order: 6, is_default: 1 },
  { name: '百度', url: 'https://www.baidu.com', description: '中文搜索引擎', category: 'hot', icon: 'https://www.baidu.com/favicon.ico', sort_order: 7, is_default: 1 },
  { name: '有道翻译', url: 'https://fanyi.youdao.com', description: '在线翻译工具', category: 'hot', icon: 'https://fanyi.youdao.com/favicon.ico', sort_order: 8, is_default: 1 },
  { name: '百度翻译', url: 'https://fanyi.baidu.com', description: '百度翻译服务', category: 'hot', icon: 'https://fanyi.baidu.com/favicon.ico', sort_order: 9, is_default: 1 },
  { name: '蓝湖', url: 'https://lanhu.cn', description: '设计协作平台', category: 'hot', icon: 'https://lanhu.cn/favicon.ico', sort_order: 10, is_default: 1 },
  { name: '有道云笔记', url: 'https://note.youdao.com', description: '云端笔记工具', category: 'hot', icon: 'https://note.youdao.com/favicon.ico', sort_order: 11, is_default: 1 },
  { name: 'ElementUI', url: 'https://element.eleme.io', description: 'Vue 2 组件库', category: 'hot', icon: 'https://element.eleme.io/favicon.ico', sort_order: 12, is_default: 1 },
  { name: 'VantUI', url: 'https://vant-ui.github.io/vant/', description: '移动端 Vue 组件库', category: 'hot', icon: 'https://vant-ui.github.io/vant/favicon.ico', sort_order: 13, is_default: 1 },
  { name: '测网速', url: 'https://www.speedtest.cn', description: '网络测速工具', category: 'hot', icon: 'https://www.speedtest.cn/favicon.ico', sort_order: 14, is_default: 1 },
  { name: '菜鸟教程', url: 'https://www.runoob.com', description: '编程学习教程', category: 'hot', icon: 'https://www.runoob.com/favicon.ico', sort_order: 15, is_default: 1 },
  { name: '语雀', url: 'https://www.yuque.com', description: '知识管理平台', category: 'hot', icon: 'https://www.yuque.com/favicon.ico', sort_order: 16, is_default: 1 },
  // —— 后面补充热门导航 ——
  { name: '淘宝', url: 'https://www.taobao.com', description: '电商购物平台', category: 'hot', icon: 'https://www.taobao.com/favicon.ico', sort_order: 17, is_default: 1 },
  { name: '京东', url: 'https://www.jd.com', description: '综合网购平台', category: 'hot', icon: 'https://www.jd.com/favicon.ico', sort_order: 18, is_default: 1 },
  { name: '天猫', url: 'https://www.tmall.com', description: '品质综合购物', category: 'hot', icon: 'https://www.tmall.com/favicon.ico', sort_order: 19, is_default: 1 },
  { name: '拼多多', url: 'https://www.pinduoduo.com', description: '社交电商平台', category: 'hot', icon: 'https://www.pinduoduo.com/favicon.ico', sort_order: 20, is_default: 1 },
  { name: '知乎', url: 'https://www.zhihu.com', description: '问答社区', category: 'hot', icon: 'https://static.zhihu.com/heifetz/favicon.ico', sort_order: 21, is_default: 1 },
  { name: '微博', url: 'https://weibo.com', description: '社交平台', category: 'hot', icon: 'https://weibo.com/favicon.ico', sort_order: 22, is_default: 1 },
  { name: '微信', url: 'https://weixin.qq.com', description: '即时通讯', category: 'hot', icon: 'https://weixin.qq.com/favicon.ico', sort_order: 23, is_default: 1 },
  { name: '支付宝', url: 'https://www.alipay.com', description: '第三方支付', category: 'hot', icon: 'https://www.alipay.com/favicon.ico', sort_order: 24, is_default: 1 },
  { name: '美团', url: 'https://www.meituan.com', description: '生活服务平台', category: 'hot', icon: 'https://www.meituan.com/favicon.ico', sort_order: 25, is_default: 1 },
  { name: '腾讯视频', url: 'https://v.qq.com', description: '在线视频平台', category: 'hot', icon: 'https://v.qq.com/favicon.ico', sort_order: 26, is_default: 1 },
  { name: '携程', url: 'https://www.ctrip.com', description: '旅行预订平台', category: 'hot', icon: 'https://www.ctrip.com/favicon.ico', sort_order: 27, is_default: 1 },
  { name: '滴滴', url: 'https://www.didi.com', description: '出行打车平台', category: 'hot', icon: 'https://www.didi.com/favicon.ico', sort_order: 28, is_default: 1 },
  { name: '什么值得买', url: 'https://www.smzdm.com', description: '优惠比价推荐', category: 'hot', icon: 'https://www.smzdm.com/favicon.ico', sort_order: 29, is_default: 1 },
  { name: '豆瓣', url: 'https://www.douban.com', description: '读书/电影/音乐社区', category: 'hot', icon: 'https://www.douban.com/favicon.ico', sort_order: 30, is_default: 1 },
  { name: '掘金', url: 'https://juejin.cn', description: '开发者技术社区', category: 'hot', icon: 'https://juejin.cn/favicon.ico', sort_order: 31, is_default: 1 },
  { name: '搜狗', url: 'https://www.sogou.com', description: '综合搜索引擎', category: 'hot', icon: 'https://www.sogou.com/favicon.ico', sort_order: 32, is_default: 1 },
]
